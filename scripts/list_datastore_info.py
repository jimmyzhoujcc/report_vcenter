   ...
   """
    ...
    try:
        ...
        for esxi_host in esxi_hosts:
            ...
            #storage_system.UnmountVmfsVolume('57af3731-857f3d4f-f704-000c298b1a38')
            #storage_system.DetachScsiLun('mpx.vmhba1:C0:T1:L0')
            #storage_system.AttachScsiLun('mpx.vmhba1:C0:T1:L0')
            #storage_system.MountVmfsVolume('57af3731-857f3d4f-f704-000c298b1a38')
            datastore_system = esxi_host.configManager.datastoreSystem
            spec = []
            datastore_system.CreateVmfsDatastore(spec)
